...
class Selector extends Component {
    ...
    */
    ...
    render() {
        ...
        let search_field = this.state.search_results.length === 0 ?
            <Typography>There are not results to show</Typography> :
                    ...
                    <ExpansionPanelDetails>
                        ...
                        <Grid container direction='column'>
                            ...
                            <Typography>User manual(alpha):
                                <a href='https://github.com/DNKonanov/Genome-Complexity-Browser/blob/master/GCB_manual.pdf'>PDF</a>
                                <br/>
                            </Typography>
                                ...
                                <Grid container direction="column" justify="space-between" alignItems="flex-start">
                                    ...
                                    <Grid item>
                                        <FormControl>
                                            ...
                                            <Select value={this.state.org} name='org'
                                                    input={<Input name="org" id="org"/>} onChange={this.handleChange}>
                            ...
                            <Grid item xs={6}>
                                <Grid container direction="column" justify="space-between" alignItems="flex-start">
                                    ...
                                    <Grid container direction="row" justify="flex-start" alignItems="flex-start">
                                        ...
                                        <Grid item xs={6}>
                                            <TextField label={'Start OG'} name='og_start' value={this.state.og_start}
                                                       onChange={this.handleChange}/>
                                        </Grid>

                                        <Grid item xs={6}>
                                            <TextField label={'End OG'} name='og_end' value={this.state.og_end}
                                                       onChange={this.handleChange}/>
                                            <Button style={{margin: 12}} color='primary' variant='contained'
                                                    onClick={(e) => {
                                                        this.checkOGs(e)
                                                    }}>Update genes</Button>
                                        </Grid>
                                    ...
                                    <Grid container direction="row" justify="flex-start" alignItems="flex-start">
                                        ...
                                        <Grid item xs={6}>
                                            <TextField label={'End coordinate'} name='coord_end'
                                                       value={this.state.coord_end} onChange={this.handleChange}/>
                                            <Button style={{margin: 12}} color='primary' variant='contained'
                                                    onClick={(e) => {
                                                        this.checkCoord(e)
                                    ...
                                    <Grid container direction="row" justify="flex-start" alignItems="flex-start"
                                        ...
                                        <Grid item>
                                            ...
                                            <FormControl>
                                                ...
                                                <Select value={this.state.method} name='method'
                                                        onChange={this.handleChange}>
                                                    {this.state.methods.map(method => <MenuItem key={method}
                                        ...
                                        <Grid item>
                                            ...
                                            <FormControl>
                                                ...
                                                <Select value={this.state.complexity_window} name='complexity_window'
                                                        onChange={this.handleChange}>
                                                    {this.props.complexity_windows.list.map(complexity_window =>
                                                        <MenuItem key={complexity_window}
                                        ...
                                        <Grid item>
                                            ...
                                            >
                                                {this.state.draw_types.map(draw_type =>
                                                    <MenuItem key={draw_type}
                                                              value={draw_type}
                                                    >{draw_type}</MenuItem>)}
                                            </Select>
                                        ...
                                        <Grid item>
                                            {this.state.user_coordinates_str.length === 0 ?
                                                <Typography style={{margin: 6}}>User coordinates are not
                                                    loaded</Typography> :
                                                <Typography style={{margin: 6}}> Coordinates was loaded
                                                    succesfully</Typography>}
                                        </Grid>
