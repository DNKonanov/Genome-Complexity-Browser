                ...
                <Container fixed>
                    <Grid container direction="row" justify="flex-start" alignItems="center">
                        ...
                        <Grid item style={{maxWidth: 100, margin: 12}}>
                            {/*<FormControlLabel*/}
                            {/*    control={<Switch name='hide_edges' value="checked" color="primary"*/}
                            {/*                     checked={this.state.hide_edges} onChange={e => this.handleChange(e)}/>}*/}
                            {/*    label="Hide reversed"/>*/}

                        </Grid>

                        {/*<Grid item style={{maxWidth: 100, margin: 12}}>*/}
                        {/*    <TextField type="number" margin="normal" label={'Tails'} name='tails'*/}
                        {/*               value={this.state.tails} onChange={this.handleChange}/>*/}
                        {/*</Grid>*/}

                        {/*<Grid item style={{maxWidth: 100, margin: 12}}>*/}
                        {/*    <TextField type="number" margin="normal" label={'Depth'} name='depth'*/}
                        {/*               value={this.state.depth} onChange={this.handleChange}/>*/}
                        {/*</Grid>*/}

                        {/*<Grid item style={{maxWidth: 150, margin: 12}}>*/}
                        {/*    <TextField type="number" margin="normal" label={'Minimal edge weight'} name='freq_min'*/}
                        {/*               value={this.state.freq_min} onChange={this.handleChange}/>*/}
                        {/*</Grid>*/}

                        <Grid item style={{maxWidth: 100, margin: 12}}>
                            <TextField type="number" margin="normal" label={'Window'} name='window'
                                       value={this.state.window} onChange={this.handleChange}/>
                        </Grid>

                        <Grid item>
                            <Button variant="contained" color="primary" onClick={this.handleGraphDraw}
